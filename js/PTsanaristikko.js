...
$(function () {
    $("#vastaa").on("click", function () {
        ...
        if (sana1_v === "sharpener") {
            ...
            $(".1_pysty").addClass("vaarin");

        }
        $(".1_pysty").on("focusin", function () {
            $(".1_pysty").removeClass("vaarin");
        ...
        if (sana2_v === "rat") {
            ...
            $(".2_pysty").addClass("vaarin");

        }
        $(".2_pysty").on("focusin", function () {
            $(".2_pysty").removeClass("vaarin");
        ...
        if (sana3_v === "pepper") {
            ...
            $(".3_pysty").addClass("vaarin");

        }
        $(".3_pysty").on("focusin", function () {
            $(".3_pysty").removeClass("vaarin");
        ...
        if (sana4_v === "cheap") {
            ...
            $(".4_pysty").addClass("vaarin");

        }
        $(".4_pysty").on("focusin", function () {
            $(".4_pysty").removeClass("vaarin");
        ...
        if (sana5_v === "card") {
            ...
            $(".5_pysty").addClass("vaarin");

        }
        $(".5_pysty").on("focusin", function () {
            $(".5_pysty").removeClass("vaarin");
        ...
        if (sana6_v === "rare") {
            ...
            $(".6_pysty").addClass("vaarin");

        }
        $(".6_pysty").on("focusin", function () {
            $(".6_pysty").removeClass("vaarin");
        ...
        if (sana7_v === "online") {
            ...
            $(".7_pysty").addClass("vaarin");

        }
        $(".7_pysty").on("focusin", function () {
            $(".7_pysty").removeClass("vaarin");
        ...
        if (sana8_p === "strawberry") {
            ...
            $(".8_vaaka").addClass("vaarin");

        }
        $(".8_vaaka").on("focusin", function () {
            $(".8_vaaka").removeClass("vaarin");
        ...
        if (sana9_p === "teacher") {
            ...
            $(".9_vaaka").addClass("vaarin");

        }
        $(".9_vaaka").on("focusin", function () {
            $(".9_vaaka").removeClass("vaarin");
        ...
        if (sana10_p === "purple") {
            ...
            $(".10_vaaka").addClass("vaarin");

        }
        $(".10_vaaka").on("focusin", function () {
            $(".10_vaaka").removeClass("vaarin");
        ...
        if (sana11_p === "again") {
            ...
            $(".11_vaaka").addClass("vaarin");

        }
        $(".11_vaaka").on("focusin", function () {
            $(".11_vaaka").removeClass("vaarin");
        ...
        if (sana12_p === "paper") {
            ...
            $(".12_vaaka").addClass("vaarin");

        }
        $(".12_vaaka").on("focusin", function () {
            $(".12_vaaka").removeClass("vaarin");
        ...
        if (sana13_p === "rules") {
            ...
            $(".13_vaaka").addClass("vaarin");

        }
        $(".13_vaaka").on("focusin", function () {
            $(".13_vaaka").removeClass("vaarin");
        ...
        if (sana14_p === "apple") {
            ...
            $(".14_vaaka").addClass("vaarin");

        }
        $(".14_vaaka").on("focusin", function () {
            $(".14_vaaka").removeClass("vaarin");
            $(".14_vaaka").removeClass("oikein");
        });

        /* vastausten tarkistus diplomia varten ja oikeiden vastausten tulostus*/
        if (sana1_v === "sharpener",
            sana2_v === "rat",
            sana3_v === "pepper",
            sana4_v === "cheap",
    ...
    let modalImg = document.getElementById("iso");
